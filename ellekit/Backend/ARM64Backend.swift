...
struct ARM64Backend: ElleKitBackend {
    let architecture: ElleKitArchitecture = .arm64
    ...
    func hook(
        ...
        arm64Hook(stockTarget, stockReplacement, internalSkipChecks)
    }
}

func arm64Hook(_ stockTarget: UnsafeMutableRawPointer, _ stockReplacement: UnsafeMutableRawPointer, _ internalSkipChecks: Bool = false) -> UnsafeMutableRawPointer? {
